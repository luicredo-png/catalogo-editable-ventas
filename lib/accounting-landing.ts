...
export type AccountingLanding={
 brand:string;whatsapp:string;topNotice:string;brochureLabel:string;
 heroEyebrow:string;heroTitle:string;heroDescription:string;heroButton:string;heroImage:string;
 pillars:LandingItem[];
...
export const defaultAccountingLanding:AccountingLanding={
 ...
 address:'Av. Principal 123 · San Isidro, Lima',phone:'(+51) 999 999 999',email:'contacto@nexocontable.pe'
};
