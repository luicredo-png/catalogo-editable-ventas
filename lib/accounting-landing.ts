...
export type AccountingLanding={
 ...
 address:string;phone:string;email:string;clientLogos:string[];
};
...
export const defaultAccountingLanding:AccountingLanding={
 ...
 address:'Av. Principal 123 · San Isidro, Lima',phone:'(+51) 999 999 999',email:'contacto@nexocontable.pe',clientLogos:[]
};
