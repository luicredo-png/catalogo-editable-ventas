...
export type AccountingLanding={
 ...
 heroEyebrow:string;heroTitle:string;heroDescription:string;heroButton:string;heroImage:string;heroTextEffect:'classic'|'dia';
 pillars:LandingItem[];
 ...
 address:string;phone:string;email:string;clientLogos:string[];showClientMarquee:boolean;
};
...
export const defaultAccountingLanding:AccountingLanding={
 ...
 address:'Av. Principal 123 · San Isidro, Lima',phone:'(+51) 999 999 999',email:'contacto@nexocontable.pe',clientLogos:[],showClientMarquee:true
};
