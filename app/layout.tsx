...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="es">
      <body className={`${geistSans.variable} ${geistMono.variable} ${outfit.variable} ${spaceGrotesk.variable} ${inter.variable} ${playfair.variable} ${cormorant.variable} ${bebas.variable} ${oswald.variable} ${abril.variable} ${cinzel.variable} ${lobster.variable} ${pacifico.variable} antialiased`}>
        {children}
      </body>
    </html>
  );
