...
INSERT INTO `__new_stores`("id", "owner_id", "owner_email", "slug", "name", "whatsapp", "accent", "background_color", "background_image", "font_family", "catalog_title", "logo_url", "created_at") SELECT "id", "owner_id", "owner_email", "slug", "name", "whatsapp", "accent", "background_color", "background_image", "font_family", "catalog_title", "logo_url", "created_at" FROM `stores`;--> statement-breakpoint
